...
class RNN(object):
	...
	def buildRNN(self):
		...
		def RMSprop(cost, params, lr=0.00005, rho=0.9, epsilon=2e-5):
			...
			for p, g in zip(params, grads):
				...
				updates.append((p, p - lr*T.clip(g,-100, 100)))
			return updates
...
if __name__ == "__main__":
	...
	# params contains: [Neuron distribution, initial learning rate,
	# 					activation function, cost function, epochs]
	params = [Neuron_Distribution, 0.1, "ReLU", "cross entropy", 1000]
